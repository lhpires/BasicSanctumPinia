    ...
    <aside class="flex justify-center items-center bg-gray-100 w-full p-6">
        <div class="text-center max-w-md">
            ...
            <form @submit.prevent="submitForm" action="#" class="space-y-5">           
                ...
                <div>
                    <button class="bg-transparent text-blue-900 border-2 border-blue-900 hover:bg-blue-900 hover:text-white font-bold text-center rounded-lg shadow-md w-full py-3 transition-colors duration-700 ease-in-out">Login</button>
                </div>                        
            </form>
        </div>
    </aside>
